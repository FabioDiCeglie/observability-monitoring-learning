...
echo -e "   • API Users:  ${YELLOW}http://localhost/api/users${NC}"
echo -e "   • API Metrics: ${YELLOW}http://localhost/api/metrics${NC}"
echo -e "   • Nginx Status: ${YELLOW}http://localhost/nginx_status${NC}"
echo ""
